...
library(dplyr)
  ...
  output$intro <- renderText({
    paste0("Hello! Our dear users, we are Wonder4. This is our ",
           ...
           We created an interactive platform using R, and we display ",
            "all the interaction with the data by using a Shiny App. ",
          
          "The dataset that we chose is from Basketball Reference, a ",
        ...
        "Our target audience is the people who are interested in ",
        ...
        "On the next tab, you can choose different player names in the ",
           "Lakers, and their photos will show up on the right with brief ",
            "personal information about them below.",
        
    "On the third tab, you will be asked to choose one player’s name ",
